...
class SecurityAnalyzer:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "Your task is to exhaustively analyze the provided Terraform JSON representation "
            "and identify ALL security misconfigurations.\n\n"
            "CRITICAL INSTRUCTIONS - You MUST check these specific areas:\n"
            "1. 'provider' blocks: Look for hardcoded secrets, access_key, or secret_key.\n"
            "2. 'resource' blocks for IAM: Look for wildcard '*' actions or overly permissive policies.\n"
            "3. 'resource' blocks for Networking: Look for publicly exposed ports (e.g., 0.0.0.0/0 in ingress).\n"
            "4. 'resource' blocks for Storage: Look for unencrypted S3 buckets, RDS, or EBS.\n\n"
            "RULES:\n"
            "- Scan the ENTIRE JSON, including 'provider' arrays.\n"
